...
function TestimonialCard({ t }: { t: (typeof testimonials)[number] }) {
  return (
    <motion.div
      ...
      className="group overflow-hidden rounded-xl border border-black/70 bg-white/80 backdrop-blur hover:bg-white shadow-sm hover:shadow-xl transition-all"
    >
          ...
          <div className="w-full lg:w-[586px] flex flex-col gap-6 md:gap-8">
            <div className="flex flex-col gap-4">
              <p className="text-[#333] font-lato text-lg md:text-xl leading-[150%]">
                Join over 2700+ students from 100+ colleges who are building
              ...
              <div className="flex flex-col gap-6 md:gap-8">
                <div className="flex flex-col gap-4">
                  ...
                  <p className="text-[#333] font-lato text-lg md:text-xl leading-[150%] text-justify">
                    No more being told you need 'experience' to get your first
                    job. BroskiesHub is where you build that experience. We
                    provide a structured, 3-phase program that guides you
                    through building a complete, real-world simulated project.
                    You go beyond theory, write production-level code, and
                    develop the professional portfolio that bypasses the
                    'fresher' tag. Your completed project is your entry ticket
                    to referrals with our partner companies.
                  </p>
                </div>
          ...
          <ParallaxBox className="w-full lg:w-[637px] h-64 md:h-96 lg:h-[530px] border-2 border-black/60 bg-white/70 backdrop-blur-md rounded-xl flex items-center justify-center shadow-[0_10px_40px_-10px_rgba(0,0,0,0.2)]">
            <div className="text-center px-8 md:px-[157px] py-8 md:py-[166px]">
              <p className="font-open-sans text-lg md:text-2xl text-black">
                ...
                that helps reinforce core value proposition and articulate what
                it is you do
              </p>
            </div>
          </ParallaxBox>
      ...
      >
        <div className="max-w-[1200px] mx-auto flex flex-col items-center gap-8 md:gap-12">
          <div className="flex flex-col items-center gap-8 md:gap-12 w-full">
            <motion.h2
              variants={fadeUp}
              className="max-w-[748px] text-center font-inter text-2xl md:text-3xl lg:text-[44px] font-bold leading-[120%] text-black px-4"
            >
              Don't Just Take Our Word For It. See What Our Interns Have Built.
            </motion.h2>
            <motion.p
              variants={fadeUp}
              className="text-center font-lato text-lg md:text-xl leading-[120%] text-black px-4"
            >
              Our interns come from India's top colleges and leave with a
              portfolio of real-world projects. They don't just learn; they
              build, innovate, and get ready for their first job. Here are a few
              of their stories.
            </motion.p>
        ...
        <div className="max-w-[836px] mx-auto flex flex-col items-center gap-6 md:gap-8">
          <div className="flex flex-col items-center gap-4">
            <h2 className="text-center font-inter text-2xl md:text-3xl lg:text-[44px] font-bold leading-[120%] text-black px-4">
              Don't Buy a Certificate to Get a Job. Build the Experience That
              Proves You're Job-Ready
            </h2>
            <p className="max-w-[740px] text-center font-lato text-base md:text-lg leading-[150%] text-[#333] px-4">
              You're caught in the Fresher's Paradox because degrees and
              tutorials aren't proof of skill. A real project is. As an
              Experience Accelerator, we provide the platform to build that
              project—the verifiable proof that beats the "experience required"
              trap and gets you hired.
            </p>
          </div>
          ...
          <div className="w-full lg:w-[534px] flex flex-col gap-6 md:gap-8">
            <div className="flex flex-col gap-4">
              ...
              <p className="font-open-sans text-sm md:text-base leading-[150%] text-subtext text-justify">
                Our solution ensures you build a multi-dimensional portfolio
                that gets you hired. We do this through our proprietary 3-phase
                program that guides you from mastering foundational skills with
                hands-on tasks, to building a complete application from a
                real-world project brief, and finally, to creating a unique
                innovation project that showcases your personal creativity to
                employers.
              </p>
            </div>
        ...
        <div className="flex flex-col lg:flex-row-reverse items-center gap-8 md:gap-[92px]">
          ...
          <div className="w-full lg:w-[534px] flex flex-col gap-6 md:gap-8">
            <div className="flex flex-col gap-4">
              ...
              <p className="font-open-sans text-sm md:text-base leading-[150%] text-subtext text-justify">
                Our solution creates a direct path from experience to
                opportunity. We accomplish this by tracking your performance on
                real projects, creating a comprehensive skill profile that goes
                far beyond a resume, and sharing this verified profile directly
                with our network of partner companies who are actively hiring
                for roles that match your new experience.
              </p>
            </div>
            <CtaLink className="bg-brand-blue-alt text-white font-bold font-lato text-sm md:text-base px-8 md:px-14 py-4 md:py-6 rounded-lg uppercase self-start hover:bg-brand-blue transition-colors">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-8 md:gap-[92px]">
          ...
          <div className="w-full lg:w-[534px] flex flex-col gap-6 md:gap-8">
            <div className="flex flex-col gap-4">
              ...
              <p className="font-open-sans text-sm md:text-base leading-[150%] text-subtext text-justify">
                Our solution provides a multi-layered support system to ensure
                you grow to a professional standard. Our unique approach
                involves providing instant, AI-powered feedback on daily tasks
                to accelerate your learning, conducting structured review
                sessions with industry mentors to guide your project
                development, and facilitating a community forum for continuous
              ...
              {[
                {
                  ...
                  description:
                    "You won't just complete small, isolated tasks. We provide a professional project brief, and you build a complete, functional application from start to finish—just like you would on a real development team.",
                },
                {
                  title: "A GitHub Portfolio, Not just a PDF Certificate",
                  description:
                    "We help you build the one credential that recruiters actually look at: a professional GitHub repository filled with clean code and a live project. This is the undeniable proof of your skills.",
                },
                {
                  title: "Mentorship & Expert Feedback",
                  description:
                    "Receive instant, AI-powered feedback on your daily tasks to learn faster, and get structured reviews from industry mentors on your major projects to ensure your work meets a professional standard.",
                },
              ].map((feature, index) => (
                <div
                  key={index}
                  className="border-2 border-black bg-white flex items-center justify-center py-12 md:py-[70px] px-6 md:px-[157px]"
                >
              ...
              {[
                {
                  ...
                  description:
                    "We don't just leave you with a portfolio. We actively share the profiles of our top-performing interns with our network of hiring startups, creating a direct path from experience to opportunity.",
                },
                {
                  title: "100% Free & Accessible",
                  description:
                    "Our program is, and always will be, completely free for students. We believe in your potential, and our model is built on having companies pay to hire our proven talent, not on students paying for a chance.",
                },
                {
                  title: "Structured 3-Phase Program",
                  description:
                    "Our unique 3-phase program takes you from mastering foundational skills to building a guided project and creating an innovation project that proves your talent.",
                },
              ].map((feature, index) => (
                <div
                  key={index}
              ...
              {[
                {
                  ...
                  description:
                    "Build your core skills through a series of hands-on tasks with instant AI feedback that accelerates your learning.",
                },
                {
                  title: "Create Your Portfolio",
                  description:
                    "Apply your skills to build a complete, real-world application that becomes the centerpiece of your new portfolio.",
                },
                {
                  title: "Connect to Opportunity",
                  description:
                    "Your portfolio is your proof. We refer our top performers directly to our hiring network for your first interview.",
                },
              ].map((step, index) => (
                <div
                  key={index}
                  className="border-2 border-black bg-white flex items-center justify-center py-16 md:py-[140px] px-6 md:px-[157px]"
                >
                  <div className="flex flex-col gap-2 text-center">
                    <h3 className="font-open-sans text-lg md:text-2xl font-bold text-black leading-[130%]">
                      {step.title}
      ...
      <section className="w-full bg-brand-gray px-4 md:px-[90px] py-12 md:py-20">
        <div className="max-w-[1303px] mx-auto flex flex-col lg:flex-row items-start gap-8 lg:gap-20">
          <div className="w-full lg:w-[586px] flex flex-col gap-6 md:gap-8">
            <div className="flex flex-col gap-4">
              <p className="text-[#333] font-lato text-lg md:text-xl leading-[150%]">
                Over 90% of tech recruiters reject 'freshers' for one reason: no
                real-world projects.
              </p>
              <div className="flex flex-col gap-6 md:gap-8">
                <div className="flex flex-col gap-4">
                  ...
                  <p className="text-[#333] font-lato text-lg md:text-xl leading-[150%] text-justify">
                    This is the moment you stop being a "fresher" and start
                    becoming a professional. Every day you wait is another day a
                    competitor is building the portfolio that will land them the
                    job you want. BroskiesHub is your direct path from a
                    theoretical degree to a tangible, job-winning portfolio that
                    proves you are ready. The choice is simple: wait for an
                    opportunity, or build one right now.
                  </p>
